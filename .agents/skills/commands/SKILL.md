...
1. Check which optional skill packs are installed by looking for their directories under `~/.Codex/skills/`.
...
4. Print the Codex built-in commands (always available).
...
## gstack (if ~/.Codex/skills/gstack exists)
