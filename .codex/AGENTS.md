...
- Convert repeated corrections into compact skills, prompt contracts, or narrowly scoped subagents; do not let repo-operating lessons live only in memories or duplicated policy blocks.
