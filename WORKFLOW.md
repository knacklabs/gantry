...
- Each leaf task must include write scope, dependencies, acceptance criteria, verify commands, and reviewer focus.
...
9. run `python3 .codex/scripts/pr_ready.py` or let `validate_work.py` mark PR-ready

Use `python3 .codex/scripts/stage_orchestrator.py` to get the exact command contract for the current phase.
