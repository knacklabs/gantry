...
const AUTONOMOUS_TOOL_CONTRACT_INSTRUCTIONS = [
  ...
  '- Scheduler control is inspect-only in this unattended run. Do not create, update, pause, resume, delete, or retrigger scheduler jobs.',
  '- If the job definition should change, include a structured proposedJobChange in the Final Job Report for an attended agent or human to review and apply.',
