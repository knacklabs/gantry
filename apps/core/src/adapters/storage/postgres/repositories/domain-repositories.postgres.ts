...
export class PostgresAgentRunRepository implements AgentRunRepository {
  ...
  async saveAgentRun(run: AgentRun): Promise<void> {
    ...
    await this.db
      ...
      .values({
        ...
        modelAliasSnapshot: run.modelAliasSnapshot ?? null,
        modelProviderSnapshot: run.modelProviderSnapshot ?? null,
        providerModelIdSnapshot: run.providerModelIdSnapshot ?? null,
        modelDisplayNameSnapshot: run.modelDisplayNameSnapshot ?? null,
  ...
  private runFromRow(
    ...
    return {
      ...
      modelProviderSnapshot: row.modelProviderSnapshot ?? undefined,
      providerModelIdSnapshot: row.providerModelIdSnapshot ?? undefined,
      modelDisplayNameSnapshot: row.modelDisplayNameSnapshot ?? undefined,
