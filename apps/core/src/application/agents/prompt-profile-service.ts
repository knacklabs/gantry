  ...
  const howToLines =
    accessPreset === 'locked'
      ...
      : [
          ...
          '- To update a selected skill, submit its complete replacement package through request_skill_proposal with targetSkillId and expectedContentHash. Never edit Gantry-managed skill files directly; the configured conversation approver must approve the update.',
