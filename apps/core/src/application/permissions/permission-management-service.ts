...
import {
  adminMcpToolFullNameFromRule,
  assertNoRequestCapabilityDefinitionConflicts,
  canonicalPersistentPermissionRules,
  expandedRevocationLiveRules,
  mergeSemanticCapabilityDefinitions,
  persistentPermissionBindingId,
  persistentPermissionGrantAuditMetadata,
  persistentPermissionRuleAuditPreviewForRules,
  resolveRevocationTarget,
  semanticCapabilityDefinitionsFromToolCatalog,
  validatePersistentRule,
} from './permission-management-rules.js';
