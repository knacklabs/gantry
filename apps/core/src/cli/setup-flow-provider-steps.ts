...
export async function runSlackStep(draft: SetupDraft): Promise<FlowAction> {
  ...
  p.note(
    [
      ...
      `   Required bot scopes: ${formatSlackBotScopes()}.`,
      ...
      '5. Install or reinstall the app to the workspace after adding files:read, files:write, canvases:read, canvases:write, or changing any scope or App Home setting; existing installations need reauthorization.',
