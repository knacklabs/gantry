...
export async function runSlackStep(draft: SetupDraft): Promise<FlowAction> {
  ...
  p.note(
    [
      ...
      '   Minimum practical scopes: chat:write, files:read, files:write, app_mentions:read, channels:read, channels:history, groups:read, groups:history, im:read, im:history, mpim:read, mpim:history.',
      ...
      '5. Install or reinstall the app to the workspace after adding files:read or changing any scope or App Home setting; existing installations need reauthorization.',
