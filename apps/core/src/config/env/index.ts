...
export const CONFIG_ENV_KEYS = [
  ...
  'INTERAKT_BASE_URL',
  'GANTRY_IPC_TRANSPORT',
  'GANTRY_IPC_SOCKET_PATH',
  'GANTRY_IPC_FRAME_MAX_BYTES',
  'GANTRY_IPC_HEARTBEAT_INTERVAL_MS',
  'GANTRY_IPC_RECONCILE_INTERVAL_MS',
  'GANTRY_IPC_EVENT_PIPE',
  'GANTRY_IPC_EVENT_PIPE_DEBOUNCE_MS',
  'GANTRY_IPC_SHUTDOWN_KILL',
  'GANTRY_IPC_ORPHAN_SWEEP',
  'GANTRY_IPC_REPLAY_PERSIST',
] as const;
