...
const CLASSIFIED_KEYS: Record<string, ClassifiedConfigKey> = {
  ...
  INTERAKT_BOT_TOKEN: runtimeSecret('INTERAKT_BOT_TOKEN'),
  INTERAKT_WEBHOOK_SECRET: runtimeSecret('INTERAKT_WEBHOOK_SECRET'),
  INTERAKT_BUSINESS_PHONE_NUMBER: runtimeSecret(
