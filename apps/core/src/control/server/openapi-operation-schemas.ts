...
export const openApiResponseSchemas: Record<string, JsonSchema> = {
  ...
  discoverProviderModels: ref('ProviderModelListingResponse'),
  ...
  registerProviderModel: ref('RegisterProviderModelResponse'),
...
export const openApiRequestSchemas: Record<string, JsonSchema> = {
  ...
  registerProviderModel: ref('RegisterProviderModelRequest'),
