...
export const openApiResponseSchemas: Record<string, JsonSchema> = {
  ...
  getDesiredState: ref('SettingsDesiredStateResponse'),
  ...
  listSettingsRevisions: ref('SettingsRevisionsResponse'),
  ...
  updateDesiredState: ref('SettingsDesiredStateUpdateResponse'),
  postDesiredState: ref('SettingsDesiredStateUpdateResponse'),
...
export const openApiRequestSchemas: Record<string, JsonSchema> = {
  ...
  enableConversationInstall: ref('ConversationInstallRouteRequest'),
  ...
  updateDesiredState: ref('SettingsDesiredStateUpdateRequest'),
  postDesiredState: ref('SettingsDesiredStateUpdateRequest'),
  ...
  updateConversationInstall: ref('ConversationInstallRouteRequest'),
