...
export const extendedOpenApiRouteDocs: RouteDoc[] = [
  ...
  doc(
    ...
    'Commits one app-scoped external result and resumes its suspended job exactly once.',
    ['jobs:write'],
    { body: 'json', parameters: [ids.capabilityTask], conflict: true },
  ),
  doc(
    'post',
    ...
    'Fenced cancellation for an app-scoped external capability invocation.',
    ['jobs:write'],
    { body: 'json', parameters: [ids.capabilityTask], conflict: true },
  ),
  doc(
    ...
    'Exceptionally rotates the completion token for an idempotently reattached waiting invocation.',
    ['jobs:write'],
    { body: 'json' },
  ),
  doc(
  ...
  doc(
    ...
    'Accepts a signed inbound payload. conversation_message targets enqueue a normal provider conversation or thread message asynchronously.',
    undefined,
  ...
  doc(
    ...
    'Observer',
    'Get observer status',
    'Returns the app-scoped observer activation state and evidence and insight counts.',
    ['memory:read'],
  ...
  doc(
    ...
    'Skills',
    'Bind skill to agent',
    'Binds an installed skill and syncs settings desired state.',
    ['skills:admin'],
