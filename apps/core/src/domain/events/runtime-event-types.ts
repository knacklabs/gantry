export const RUNTIME_EVENT_TYPES = {
  ...
  CHANNEL_REPLAY_STARTED: 'channel.replay.started',
  CHANNEL_REPLAY_COMPLETED: 'channel.replay.completed',
  CHANNEL_REPLAY_FAILED: 'channel.replay.failed',
  ...
  IDENTITY_OFFBOARDED: 'identity.offboarded',
  IDENTITY_MERGED: 'identity.merged',
  IDENTITY_UNMERGED: 'identity.unmerged',
