...
// Narrow predicate for IPv4 127.0.0.0/8 or IPv6 ::1 only. Used to permit
// agent-runtime SDK projection of an MCP server URL that targets the
// Gantry-local MCP server, which doesn't require the
// DNS-pinned host transport that general remote http/sse MCP servers need.
