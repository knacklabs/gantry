...
describe('handleRemoteControlCommand', () => {
  ...
  it('sends URL on successful /remote-control start', async () => {
    ...
    const { startRemoteControl } =
      await import('@core/runtime/remote-control.js');
    ...
    vi.doMock('@core/runtime/remote-control.js', () => ({
    ...
    vi.resetModules();
    const rcCmd = await import('@core/runtime/remote-control-command.js');
    ...
    vi.doUnmock('@core/runtime/remote-control.js');
    vi.resetModules();
  });
