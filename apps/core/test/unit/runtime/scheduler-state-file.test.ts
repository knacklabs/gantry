...
import { Job, JobEvent, JobRun } from '@core/core/types.js';
import { writeSchedulerStateFile } from '@core/runtime/scheduler-state-file.js';
...
describe('writeSchedulerStateFileSafe', () => {
  it('does not throw when underlying write fails', async () => {
    ...
    vi.resetModules();
    const mod = await import('@core/runtime/scheduler-state-file.js');
