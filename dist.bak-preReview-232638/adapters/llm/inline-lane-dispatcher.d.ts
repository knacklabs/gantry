...
import type { AgentControlThinking, ConversationRoute } from '../../domain/types.js';
import type { RunnerOutputFrame } from '../../runner/runner-frame.js';
import type { AgentPersona } from '../../shared/agent-persona.js';
import type { YoloModeSettings } from '../../shared/yolo-mode-policy.js';
import type { PermissionMode } from '../../shared/permission-mode.js';
export declare const DEFAULT_INLINE_AGENT_MAX_TURNS = 50;
...
export declare function inlineAgentMaxTurnsError(limit: number, newSessionId?: string): RunnerOutputFrame;
...
export interface InlineCoreToolRegistry {
    ...
    execute(name: string, input: unknown, context?: {
        signal?: AbortSignal;
    }): Promise<{
        content: Array<{
            type: 'text';
...
export type AdapterInlineAgentLoopLane = (input: AdapterInlineAgentLoopLaneInput) => Promise<InlineAgentOutputFrame>;
export type ProviderInlineAgentLoopLane = (input: AdapterInlineAgentLoopLaneInput & {
    coreTools: InlineCoreToolRegistry;
    egressDenylist: readonly string[];
}) => Promise<InlineAgentOutputFrame>;
export declare function createInlineAgentLoopLaneDispatcher(input: {
    claudeLane: ProviderInlineAgentLoopLane;
    deepAgentsLane: ProviderInlineAgentLoopLane;
    createCoreTools: (laneInput: AdapterInlineAgentLoopLaneInput) => InlineCoreToolRegistry | Promise<InlineCoreToolRegistry>;
