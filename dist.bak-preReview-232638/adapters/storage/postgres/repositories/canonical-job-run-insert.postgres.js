...
import { CANONICAL_APP_ID, DEFAULT_LLM_PROFILE_ID, } from './canonical-graph-repository.postgres.js';
...
export async function insertCanonicalJobRun(input) {
    ...
    const maxAttempts = run.job_id && !explicitShortId ? JOB_RUN_INSERT_MAX_ATTEMPTS : 1;
...
function isJobRunShortIdUniqueViolation(err) {
