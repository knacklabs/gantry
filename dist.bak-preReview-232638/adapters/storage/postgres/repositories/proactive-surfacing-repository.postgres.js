...
function subjectWhere(subject) {
    return and(eq(table.appId, subject.appId), eq(table.agentId, subject.agentId), eq(table.subjectType, subject.subjectType), eq(table.subjectId, subject.subjectId));
}
function mapRow(row) {
    return {
        id: row.id,
