...
export const pendingAccessRequestsPostgres = pgTable('pending_access_requests', {
    ...
    pendingByAppIdx: index('idx_pending_access_requests_app_status').on(table.appId, table.status, table.expiresAt),
}));
