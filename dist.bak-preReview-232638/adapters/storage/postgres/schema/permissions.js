...
export const permissionAuditEventsPostgres = pgTable('permission_audit_events', {
    id: text('id').primaryKey(),
    appId: text('app_id')
        .notNull()
        .references(() => appsPostgres.id, { onDelete: 'cascade' }),
    decisionId: text('decision_id').references(() => permissionDecisionsPostgres.id, { onDelete: 'set null' }),
