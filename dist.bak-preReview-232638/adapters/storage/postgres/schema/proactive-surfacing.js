 ...
 */
export const proactiveSurfacingOptInsPostgres = pgTable('proactive_surfacing_opt_ins', {
    ...
    subjectUnique: uniqueIndex('proactive_surfacing_opt_ins_subject_unique').on(table.appId, table.agentId, table.subjectType, table.subjectId),
}));
