...
export function mapCanonicalRunRecord(row) {
    return {
        run_id: row.id,
        short_id: row.shortId,
        job_id: row.jobId || '',
        execution_provider_id: row.executionProviderId,
...
export function mapCanonicalJobEventRecord(row, index, fallbackJobId) {
