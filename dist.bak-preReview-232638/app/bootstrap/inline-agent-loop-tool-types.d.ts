...
export interface InlineCoreToolHostDeps extends CoreSendMessageDeps {
    ...
    getConversationRoutes(): Record<string, import('../../domain/types.js').ConversationRoute>;
    ...
    createTaskLifecycleBackend(laneInput: InlineAgentLoopLaneInput, authorityToolName?: 'AgentDelegation'): CoreTaskLifecycleBackend | undefined;
}
export type InlineCoreToolSupport = Pick<CoreToolRegistryDeps, 'evaluateToolPreChecks' | 'evaluateToolPolicy' | 'formatMemorySearchResponse' | 'formatMemoryWriteResponse'> & {
