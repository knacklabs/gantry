...
export declare const PROCESS_ROLE_ENV_VAR = "GANTRY_PROCESS_ROLE";
/** Workstation default; behaves exactly as the historical single process. */
export declare const DEFAULT_PROCESS_ROLE: ProcessRole;
/** Every valid role value, in declaration order. */
export declare const PROCESS_ROLES: readonly ProcessRole[];
