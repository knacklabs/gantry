import type { Job, JobAccessRequirement, JobEvent, JobRun, JobScheduleType } from '../../domain/types.js';
...
import type { RuntimeEventFilter, RuntimeEventPublishInput } from '../../domain/events/events.js';
import type { JobUpsertInput, RuntimeJobRepository } from '../../domain/repositories/ops-repo.js';
...
export interface JobControlPort {
    ...
    getAppSessionByChatJid(conversationJid: string): Promise<AppSessionRecord | undefined>;
    getAppSessionsByChatJids?(conversationJids: readonly string[]): Promise<AppSessionRecord[]>;
...
export interface JobTriggerQueuePort {
    isReady(): boolean;
    enqueue(jobId: string, triggerId: string, options?: {
        runId?: string;
    }): Promise<void>;
    /**
