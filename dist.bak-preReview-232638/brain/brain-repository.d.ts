import type { BrainEdge, BrainEdgeType, BrainEmbeddingConfig, BrainEntity, BrainEntityKind, BrainGraph, BrainPage, BrainPageSourceKind, BrainStatus } from './brain-types.js';
...
export interface BrainRepository {
    ...
    getEntityByName(appId: string, kind: BrainEntityKind, normalizedName: string): Promise<BrainEntity | null>;
