import { agentTodoStopActions, countCompletedAgentTodos, formatAgentProgressLine, formatAgentTodoHeader, formatAgentTodoLine, hasAgentTodoCardHeader, } from '../agent-todo-render.js';
 ...
 */
export function buildAgentTodoBlocks(render, options = {}) {
        ...
        return [
            {
                ...
                text: {
                    type: 'mrkdwn',
                    text: truncateSlackText(formatAgentProgressLine(render, escapeSlackMrkdwn), 2900),
                },
            },
        ];
    }
    ...
    const actionBlocks = slackMessageActionBlocks('', agentTodoStopActions(render), { providerAccountId: options.providerAccountId })?.filter((block) => block.type === 'actions');
