...
import { escapeTelegramMarkdownV2Literal, } from './channel-shared.js';
export function createTelegramBotRuntime(botToken) {
...
export function registerTelegramBotCommands(bot, assistantName) {
    void bot.api
        .setMyCommands([
    ...
    bot.command('chatid', (ctx) => {
        ...
        ctx.reply(`Chat ID: \`tg:${escapeTelegramMarkdownV2Literal(String(chatId))}\`\nName: ${escapeTelegramMarkdownV2Literal(chatName)}\nType: ${escapeTelegramMarkdownV2Literal(chatType)}`, { parse_mode: 'MarkdownV2' });
    });
