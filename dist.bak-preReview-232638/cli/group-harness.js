...
import { loadRuntimeSettings, writeDesiredRuntimeSettings, } from '../config/settings/runtime-settings.js';
...
function parseArgs(args) {
    ...
    if (!selector || !agentHarness || rest.length > 0) {
        return {
            error: 'Usage: gantry agent harness <jid|folder> <auto|anthropic_sdk|deepagents>',
        };
    }
...
export async function runHarness(runtimeHome, args) {
