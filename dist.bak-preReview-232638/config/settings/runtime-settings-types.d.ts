import type { RuntimeMemorySettingsSnapshot, RuntimeStorageSettingsSnapshot } from './memory-snapshot.js';
...
export type RuntimeConversationKind = 'dm' | 'direct' | 'group' | 'channel' | 'chat' | 'service' | 'web';
...
export interface RuntimeSettings {
    ...
    conversationInstalls: Record<string, RuntimeConfiguredConversationInstall & {
