...
const arrayEnvelope = (name, itemRef) => envelope(name, {
    type: 'array',
    items: { $ref: `#/components/schemas/${itemRef}` },
});
export const adminOpenApiSchemas = {
    Provider: {
        type: 'object',
    ...
    ProviderAccountListResponse: arrayEnvelope('providerAccounts', 'ProviderAccount'),
    ...
    ConversationThreadListResponse: arrayEnvelope('threads', 'ConversationThread'),
    ...
    ConversationInstallListResponse: arrayEnvelope('conversationInstalls', 'ConversationInstall'),
