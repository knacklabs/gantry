import { errors, } from './openapi-route-helpers.js';
import { openApiRequestSchemas, openApiResponseSchemas, } from './openapi-operation-schemas.js';
...
function statusDescription(status) {
    ...
    if (status === '409')
        return 'Request conflicts with current API policy.';
    return 'Request succeeded.';
}
function operationFromDoc(doc) {
...
export const GANTRY_OPENAPI_DOCUMENT = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'Provider-neutral runtime Control API for SDK sessions, jobs, providers, conversations, memory, capabilities, skills, MCP servers, webhooks, and signed external ingresses.',
        license: { name: 'MIT' },
    },
    servers: [
        {
            url: 'http://127.0.0.1:8787',
            description: 'TCP control server when GANTRY_CONTROL_PORT is set. Defaults to loopback; set GANTRY_CONTROL_HOST=0.0.0.0 only behind an authenticated deployment boundary.',
        },
    ],
    tags: [
    ...
    components: {
        securitySchemes: {
            bearerAuth: {
                ...
                description: 'Use a token from GANTRY_CONTROL_API_KEYS_JSON. Operation-specific scopes are listed in x-gantry-required-scopes.',
            },
        },
        schemas: {
            ...openApiSchemas,
...
export function getGantryOpenApiDocument() {
