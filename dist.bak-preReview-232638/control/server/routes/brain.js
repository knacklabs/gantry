import { countRuntimeBrainHarvestEnabledConversations, createRuntimeBrainService, } from '../../../brain/brain-runtime.js';
...
export async function handleBrainRoutes(req, res, ctx, url, pathname) {
    ...
    if (pathname === '/v1/brain/status' && req.method === 'GET') {
        ...
        sendJson(res, 200, {
            status: {
                ...
                harvestEnabledConversations: countRuntimeBrainHarvestEnabledConversations(),
            },
        });
        return true;
    }
