...
import { executionRoutesForEntry, resolveExecutionRoute, } from '../../../shared/model-execution-route.js';
function modelRecord(entry) {
    return {
        id: entry.id,
...
export function agentModelPreview(ctx, body) {
