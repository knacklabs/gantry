export const RUNTIME_EVENT_TYPES = {
    ...
    SESSION_COMPACTION_QUEUED: 'session.compaction.queued',
    SESSION_COMPACTION_RUNNING: 'session.compaction.running',
    SESSION_COMPACTION_READY: 'session.compaction.ready',
...
const RUNTIME_EVENT_TYPE_VALUES = new Set(Object.values(RUNTIME_EVENT_TYPES));
const RUNTIME_EVENT_TYPE_ALIASES = {
...
export function isRuntimeEventType(value) {
    return (typeof value === 'string' &&
        RUNTIME_EVENT_TYPE_VALUES.has(value));
}
export function parseRuntimeEventType(value) {
...
export function requireRuntimeEventType(value, context = 'Runtime event type') {
    if (isRuntimeEventType(value))
        return value;
