...
export type JobStatus = 'active' | 'paused' | 'running' | 'completed' | 'dead_lettered';
...
export type JobCapabilityRequirementImplementationKind = 'configured_access' | 'local_cli' | 'mcp_server' | 'builtin_tool';
...
export type JobSetupReadinessState = 'ready' | 'missing_capability' | 'broker_unreachable' | 'credential_unknown' | 'browser_login_may_be_required' | 'mcp_missing_credential';
export interface JobSetupBlocker {
    state: Exclude<JobSetupReadinessState, 'ready'>;
    message: string;
    nextAction: string;
    requirementType: 'tool' | 'semantic_capability' | 'browser' | 'mcp_server' | 'credential' | 'local_cli';
...
export type JobRecoveryIntentKind = 'setup_required' | 'missing_capability' | 'permission_denied' | 'permission_timeout';
export type JobRecoveryIntentState = 'pending' | 'running' | 'completed' | 'failed' | 'suppressed';
...
export type JobRunStatus = 'running' | 'paused' | 'completed' | 'failed' | 'timeout' | 'dead_lettered';
