...
export type AgentCredentialPurpose = 'model_runtime' | 'model_batch' | 'tool_capability';
export declare const MODEL_RUNTIME_CREDENTIAL_IDENTIFIER = "gantry-model-access";
export declare const MODEL_RUNTIME_CREDENTIAL_NAME = "Gantry Model Access";
