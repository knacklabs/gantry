...
export type OutboundDeliveryStatus = 'pending' | 'claimed' | 'sent' | 'partially_delivered' | 'failed';
export type OutboundDeliveryItemStatus = 'pending' | 'claimed' | 'sent' | 'failed' | 'partially_delivered';
...
export declare class OutboundDeliveryIdempotencyConflictError extends Error {
