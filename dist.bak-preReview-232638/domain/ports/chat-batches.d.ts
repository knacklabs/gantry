export declare const CHAT_BATCH_STATES: readonly ["submission_intent", "preflight_failed", "submission_unknown", "submitted", "processing", "applied", "failed", "abandoned"];
...
export declare class ChatBatchDailyCostLimitError extends Error {
    constructor();
}
...
export interface ChatBatchRepository {
    ...
    recordPreflightFailure(input: ChatBatchIntentCreate & {
        error: string;
    }): Promise<ChatBatchRecord>;
