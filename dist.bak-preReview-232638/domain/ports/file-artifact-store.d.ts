import type { FileArtifact, FileArtifactDescriptor, FileArtifactId } from '../file-artifacts/file-artifact.js';
...
export interface FileArtifactStore {
    ...
    listFileArtifacts(input: FileArtifactListInput): Promise<FileArtifactDescriptor[]>;
