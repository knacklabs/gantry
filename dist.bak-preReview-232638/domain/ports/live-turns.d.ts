 ...
 */
export declare function makeLiveTurnScopeKey(scope: LiveTurnScope): string;
export type LiveTurnState = 'claimed' | 'running' | 'awaiting_interaction' | 'setup_required' | 'recovered' | 'completed' | 'failed' | 'timed_out';
export declare const LIVE_TURN_TERMINAL_STATES: readonly ["completed", "failed", "timed_out"];
export declare function isTerminalLiveTurnState(state: LiveTurnState): boolean;
...
export type LiveTurnCommandType = 'continuation' | 'stop' | 'close_stdin' | 'new_session' | 'compact' | 'interaction_resolved';
...
export type LiveAdmissionWorkItemState = 'queued' | 'claimed' | 'deferred' | 'completed' | 'failed' | 'canceled';
export declare const LIVE_ADMISSION_TERMINAL_STATES: readonly ["completed", "failed", "canceled"];
...
export interface LiveAdmissionWorkItemRepository {
    ...
    settleLiveAdmissionWorkItem(input: {
        ...
        claimToken: string;
        workerInstanceId: string;
        state: Extract<LiveAdmissionWorkItemState, 'completed' | 'failed' | 'canceled'>;
        now?: string;
    }): Promise<boolean>;
}
...
export interface LiveTurnCommandRepository {
     ...
     */
    appendLiveTurnCommand(input: LiveTurnCommandAppendInput): Promise<LiveTurnCommandAppendResult>;
...
export interface LiveTurnCoordinationRepository extends LiveTurnRepository, LiveTurnCommandRepository, LiveAdmissionWorkItemRepository {
}
