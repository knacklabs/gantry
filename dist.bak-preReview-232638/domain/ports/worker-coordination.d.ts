import type { PermissionCallbackClaim, PermissionCallbackClaimReference, PermissionCallbackScope, PermissionRecoveryEnvelope } from '../types.js';
import type { LiveTurnCommandAppendInput } from './live-turns.js';
export type WorkerInstanceStatus = 'starting' | 'healthy' | 'unhealthy' | 'draining' | 'stopped';
...
export type RunLeaseStatus = 'active' | 'expired' | 'released' | 'completed' | 'failed';
...
export type RunnerControlEventType = 'claimed' | 'heartbeat' | 'output' | 'log' | 'terminal_state' | 'permission_requested' | 'question_requested' | 'permission_resolved' | 'stop' | 'completed' | 'failed';
export type RunnerControlEventAppendResult = 'persisted' | 'replayed' | 'fenced';
...
export type PendingInteractionStatus = 'pending' | 'resolved' | 'expired' | 'cancelled';
...
export type PermissionPromptSettlementState = 'open' | 'claimed' | 'settled' | 'review_each_expired' | 'superseded';
...
export interface WorkerCoordinationRepository extends WorkerRegistryRepository, RunLeaseRepository, RunSlotRepository, RunnerControlEventRepository, PendingInteractionRepository, TransientGrantRepository {
}
