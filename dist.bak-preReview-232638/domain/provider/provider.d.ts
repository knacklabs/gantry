...
import type { ConversationId, ConversationThreadId, ExternalConversationId } from '../conversation/conversation.js';
...
export type ConversationInstallMemoryScope = 'user' | 'conversation' | 'agent' | 'app';
