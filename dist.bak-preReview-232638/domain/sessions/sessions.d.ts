...
import type { ConversationId, ConversationThreadId, UserId } from '../conversation/conversation.js';
...
export declare function scopedDigestMetadataForSession(session: AgentSession): AgentSessionDigestScopeMetadata;
