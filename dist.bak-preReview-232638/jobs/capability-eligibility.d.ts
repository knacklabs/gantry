...
export declare const EMPTY_REQUIRED_CAPABILITIES: readonly string[];
 ...
 */
export declare function resolveRequiredCapabilities(deps: RequiredCapabilityResolverDeps, input: {
    appId: string;
    agentId: string;
}): Promise<string[]>;
/** Sort + de-dupe a capability id list into the canonical flat-set shape. */
export declare function normalizeCapabilitySet(capabilities: readonly string[] | null | undefined): string[];
/**
 ...
 */
export declare function isWorkerEligibleForRequiredCapabilities(required: readonly string[] | null | undefined, advertised: readonly string[] | null | undefined): boolean;
/**
 ...
 */
export declare function missingRequiredCapabilities(required: readonly string[] | null | undefined, advertised: readonly string[] | null | undefined): string[];
