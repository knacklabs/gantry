...
import type { ConversationRoute, StreamingChunkOptions } from '../domain/types.js';
import type { RuntimeAgentSessionRepository, RuntimeJobRepository } from '../domain/repositories/ops-repo.js';
...
export interface SchedulerDependencies {
    ...
    queue: GroupQueue;
    onProcess: (groupJid: string, proc: ChildProcess, runHandle: string, workspaceFolder: string, stopAliasJids?: string[]) => void;
...
export type JobTurnContext = Awaited<ReturnType<NonNullable<SchedulerDependencies['opsRepository']['getAgentTurnContext']>>>;
