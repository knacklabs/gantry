        ...
        output: [
            {
                ...
                value: 'The user prefers concise responses without motivational or cheerleading language.',
        ...
        output: [
            {
                ...
                value: 'IPC lock recovery only reclaims locks whose owner PID is confirmed dead, not on timeout.',
