...
import { capabilityStatusText, chatJid, jobId, jobRunId, jobRunLeaseFencingVersion, jobRunLeaseToken, lockedAccessPreset, providerAccountId, TASKS_DIR, threadId, } from '../context.js';
import { waitForTaskResponse, writeIpcFile } from '../ipc.js';
import { makeIpcId } from '../ipc-ids.js';
import { MCP_PROXY_WAIT_MS } from './service-constants.js';
import { formatMcpCallToolResponse, formatMcpDescribeToolResponse, formatMcpListToolsResponse, formatMcpSearchToolsResponse, } from './service-formatters.js';
export function registerMcpProxyTools(server) {
    server.tool('mcp_list_tools', lockedAccessPreset
    ...
    server.tool('mcp_search_tools', lockedAccessPreset
    ...
    server.tool('mcp_describe_tool', lockedAccessPreset
    ...
    server.tool('mcp_call_tool', lockedAccessPreset
    ...
    server.tool('async_mcp_call', lockedAccessPreset
...
function modelVisibleMcpCallResult(data) {
    if (!data ||
        typeof data !== 'object' ||
        Array.isArray(data) ||
