...
import { PermissionApprovalDecision, PermissionApprovalCancellation, PermissionApprovalRequest, RichInteractionRequest, ConversationRoute, UserQuestionCancellation, UserQuestionRequest, UserQuestionResponse } from '../domain/types.js';
import type { RuntimeJobRepository, RuntimeMessageRepository } from '../domain/repositories/ops-repo.js';
import type { HostnameLookup } from '../domain/network/public-address-policy.js';
import type { CapabilitySecretRepository, AgentRepository, McpServerRepository, PermissionRepository, SkillCatalogRepository, ToolCatalogRepository } from '../domain/ports/repositories.js';
import type { AgentTodoRender } from '../domain/ports/task-lifecycle.js';
import type { AgentCredentialBroker } from '../domain/ports/agent-credential-broker.js';
import type { CredentialBrokerProfile } from '../domain/models/credentials.js';
import type { JobControlPort, JobManagementServiceDeps, RuntimeEventPublisherPort } from '../application/jobs/job-management-types.js';
...
export interface IpcDeps {
    ...
    registerGroup: (jid: string, group: ConversationRoute) => Promise<void> | void;
    syncGroups: (force: boolean) => Promise<void>;
    getAvailableGroups: () => Promise<AvailableGroup[]> | AvailableGroup[];
    writeGroupsSnapshot: (workspaceFolder: string, availableGroups: AvailableGroup[], registeredJids: Set<string>) => Promise<void> | void;
    ...
    renderAgentTodo?: (jid: string, render: AgentTodoRender, options?: {
        providerAccountId?: string;
    }) => Promise<boolean>;
    renderRichInteraction?: (jid: string, request: RichInteractionRequest, options?: {
        providerAccountId?: string;
    }) => Promise<boolean>;
    ...
    getPermissionDecisionMemoryRepository?: () => PermissionDecisionMemoryRepository | undefined;
    ...
    getPermissionMessageRepository?: () => Pick<RuntimeMessageRepository, 'getRecentTopLevelMessagesBefore' | 'getLatestThreadMessages'>;
    ...
    getBrowserUsageSettings?: () => BrowserUsageSettings | undefined | Promise<BrowserUsageSettings | undefined>;
}
