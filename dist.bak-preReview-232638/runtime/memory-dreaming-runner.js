...
import { DEFAULT_MEMORY_APP_ID, memoryAgentIdForWorkspaceFolder as memoryAgentIdForGroup, } from '../memory/app-memory-boundaries.js';
...
export async function runDreamingForGroup(input) {
    ...
    const result = await memoryMaintenanceQueue.enqueueAndWait(input.folder, async () => {
