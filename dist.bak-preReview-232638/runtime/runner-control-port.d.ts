export type RunnerControlRequestLane = 'messages' | 'tasks' | 'memory-requests' | 'browser-requests' | 'permission-requests' | 'permission-cancellations' | 'question-cancellations' | 'rich-interactions' | 'user-questions';
export type RunnerControlResponseLane = 'browser-responses' | 'memory-responses' | 'permission-responses' | 'task-responses' | 'user-answers';
