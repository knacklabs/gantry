...
const BEDROCK_AP_SOUTH_1_AVAILABILITY = {
    verifiedAt: '2026-06-22',
    evidence: {
        source: 'provider_cli',
        commandOrUrl: 'aws bedrock list-foundation-models --region ap-south-1 --by-output-modality TEXT',
    },
...
export function buildBedrockCatalog(deps) {
    return BEDROCK_CHAT_MODELS.map(([id, providerModelId, displayName, aliases, recommendedAlias, contextWindowTokens,]) => deps.executableModelEntry({
        id: `bedrock:${id}`,
