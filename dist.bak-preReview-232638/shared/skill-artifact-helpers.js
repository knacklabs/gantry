...
export function normalizeSkillAssetPath(value) {
...
export function readSkillMdAssetText(assets) {
    const skillMd = assets.find((asset) => normalizeSkillAssetPath(asset.path) === 'SKILL.md');
    if (!skillMd) {
        throw new Error('Skill asset bundle must include SKILL.md.');
    }
    return Buffer.from(skillMd.content).toString('utf-8');
}
export function writeSkillAssets(assets, targetDir) {
...
export function cleanSkillMetadataText(value) {
