...
| YOLO denylist hit → host hard-deny + event before cache/classifier/prompt                                                                                                                                                                                                                                                                                                                                                                                                                                                               | integration                         | ✅ permission-decision-chain.postgres.integration.test.ts (no execution, no prompt)                                                                                                               |
...
| Record-before-prompt ordering                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | integration                         | ✅ permission-decision-chain.postgres.integration.test.ts                                                                                                                                       |
...
| Deny: recorded, no execution                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | integration                         | ✅ permission-decision-chain.postgres.integration.test.ts                                                                                                                                       |
| NO chat receipt on allow-future (regression, #239)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | integration                         | ✅ permission-decision-chain.postgres.integration.test.ts                                                                                                                                       |
...
| Whole-chain credential-absence in events/logs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | integration                         | ✅ permission-decision-chain.postgres.integration.test.ts                                                                                                                                       |
...
| GET /v1/sessions/{id}/runs returns the session's runs with executionProviderId (today it maps the control-session id into agent-session id space and always returns []); session events feed exposes run.\* lifecycle | integration      | 🔨 feature gap found by rounds 16-17                                                                                   |
...
| Delegated/async task lifecycle plumbing (create → run → complete → result surfaced; failure → clean terminal state)                                                                                                                      | integration                             | ✅ ipc-agent-task-lifecycle units · agent-delegation-task-lifecycle.postgres.integration.test.ts |
