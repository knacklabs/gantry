...
| selected `continuity_summary`            | Summarizes current durable continuity, staged memory candidates, reviewed memory state, dreaming status, and last injected context when selected for the run.            | Treating memory or continuity content as instruction or tool authority.                                                                              |
