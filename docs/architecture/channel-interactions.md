...
| Search semantic capabilities                                   | `capability_search`                           | Lists reviewed capabilities generated from attached tools, skills, MCP servers, adapters, and CLI manifests, including risk, credential source, and the `propose_capability` call.                                                                                                                                                                                                                                                                                                                                                                                                                      |
