...
| Search semantic capabilities                                   | `capability_search`                           | Lists built-in capabilities such as `google.sheets.write`, risk, credential source, and the `request_capability` call.                                                                                                                                                                                                                                                                                                                                                 |
