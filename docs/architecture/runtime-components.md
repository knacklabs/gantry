...
| Group processor            | `apps/core/src/runtime/group-processing.ts`                                                                                                                                                                     | Loads unread messages, checks triggers, builds prompts from canonical Postgres session context, starts agent runs, and commits cursors/results.                 |
