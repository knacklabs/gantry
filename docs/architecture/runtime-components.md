...
| Channels                   | `apps/core/src/app/bootstrap/channel-wiring.ts`, `apps/core/src/channels/channel-provider.ts`, `apps/core/src/channels/slack/`, `apps/core/src/channels/discord/`, `apps/core/src/channels/telegram/`                            | Connect Slack, Discord, Telegram, and app channel adapters; route inbound messages, outbound replies, progress, streaming, typing, and permission prompts. Teams remains setup/discovery-only. |
