...
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bootstrap and orchestrator | `apps/core/src/index.ts`, `apps/core/src/app/bootstrap/startup.ts`, `apps/core/src/app/bootstrap/runtime-services.ts`                                                                                                            | Create `RuntimeApp`, initialize Postgres storage, wire channels, start socket IPC, scheduler, queue wakeups, and control server.                                                             |
...
| Message loop               | `apps/core/src/runtime/message-loop.ts`                                                                                                                                                                                          | Recovers pending messages after restart and provides shared message processing helpers; fresh inbound messages wake the queue through runtime events.                                          |
...
| Follow-up is ignored                       | `apps/core/src/runtime/continuation-delivery.ts`, `apps/core/src/runtime/ipc-socket-server.ts`, `apps/core/src/runtime/group-queue.ts`                                                                                                                         | Whether the active run is socket-bound, accepts continuation frames, uses the expected queue key/thread key, and handles stop aliases.                                                                                                                                                     |
