...
date: 2026-06-12
superseded_by: 0028-agent-harness-selection
---

# Agent Engine Selection

> **Status: SUPERSEDED by
> [Agent Harness Selection (2026-06-14)](./0028-agent-harness-selection.md).**
...
`docs/decisions/0018-provider-neutral-agent-execution-adapter.md`). The
