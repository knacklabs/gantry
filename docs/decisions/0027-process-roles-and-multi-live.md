...
[2026-06-11 — Deployment Modes](./0023-deployment-modes.md) shipped the
...
This supersedes [2026-06-11 — Deployment Modes](./0023-deployment-modes.md)
...
- **Make the process role a `settings.yaml` key.** Rejected: a settings key is
  ...
  env var ([2026-06-11 — Deployment Modes](./0023-deployment-modes.md) §2).
...
- [2026-06-11 — Deployment Modes](./0023-deployment-modes.md) (superseded
  §4/§5)
