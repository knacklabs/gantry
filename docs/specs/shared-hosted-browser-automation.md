...
application capabilities selected for that agent. The first consumer is one business workflow;
Additional workflows can add separate agents, profiles, skills, and API capabilities later.
