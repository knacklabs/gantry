# Storage module: one S3 bucket for capability artifacts (skills/, toolchains/)
# with split IAM — the bake role has read-write, workers have read-only. This is
# the infrastructure enforcement of "workers never mutate capability state"
# (decisions/2026-06-11-capability-artifacts.md, delivery-vehicle ADR-2).
