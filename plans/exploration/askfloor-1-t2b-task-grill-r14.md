...
Round 13 (sol @ xhigh) returned CONTRACT SOUND on the current decomposition (it re-read after the round-13 astra fold landed). Round 14 is an astra-only re-check of that same recorded contract.
