...
- `revision` is an unbounded monotonic counter (a live card is at 10,115): validated as a safe integer ≥ 0 with NO upper cap BY DESIGN — do not propose reusing the MAX_PART_COUNT-capped reader.
