...
- Length bound BY DESIGN: item labels/details are truncated with the existing view limits (itemLabel 50, itemDetail 70) and the list is capped at the view item limit (10, including the rollup's '+N more'); with the already-compacted summary the complete edit stays far below Telegram's 4096 chars — do not propose a second whole-message truncation.
